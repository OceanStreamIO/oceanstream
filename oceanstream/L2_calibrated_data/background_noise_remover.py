...
After processing, `Sv_corrected` and `Sv_noise` variables have been removed.
...
def apply_remove_background_noise(
    ...
    cleaned_ds = ds_Sv_corrected.copy(deep=True)
    # Store original Sv values in Sv_original
    cleaned_ds["Sv_original"] = cleaned_ds["Sv"].copy(deep=True)
    # Replace Sv with Sv_corrected values
    cleaned_ds["Sv"] = cleaned_ds["Sv_corrected"]
    cleaned_ds = cleaned_ds.drop_vars(["Sv_corrected", "Sv_noise"])
    return cleaned_ds
